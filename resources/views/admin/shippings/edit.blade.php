...
<?php
$lat = !empty($shipping->lat)?$shipping->lat:30.129090714411333;
$lng = !empty($shipping->lng)?$shipping->lng:31.267706871032715;
  ...
  <div class="box-body">
    ...
    <div class="form-group">
     ...
     <div class="form-group">
        ...
        <img src="{{ Storage::url($shipping->icon) }}" style="width:50px;hight:50px" >
        @endif
